# auth/support_mail_templates.py
...
<body style="margin: 0; padding: 0; background-color: #f6f9fc; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="container" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td class="header-cell" align="center" style="background: linear-gradient(135deg, #000000 0%, #1a1a1a 100%); padding: 40px 24px;">
                            ...
                            <p style="color: #ffffff; font-size: 16px; margin: 0; opacity: 0.9; font-weight: 500;">🎧 Support Team</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 36px 40px 24px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="ticket-info" style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-radius: 12px; border: 1px solid #e5e7eb; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 24px;">
                                        <h3 style="font-size: 16px; font-weight: 700; color: #1a1a1a; margin: 0 0 16px 0;">📋 Ticket Details</h3>
                            ...
                            <div style="background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border: 1px solid #93c5fd; border-radius: 10px; padding: 20px; margin: 0 0 24px 0;">
                                <h3 style="font-size: 15px; font-weight: 700; color: #1e40af; margin: 0 0 12px 0;">⏰ What happens next?</h3>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="btn-container">
                                <tr>
                                    <td align="center" style="padding: 8px 0 24px 0;">
                                        ...
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{FRONTEND_URL}/support/ticket/{ticket_number}" class="btn" style="display: inline-block; background: #113CCF; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 700; padding: 15px 32px; border-radius: 8px; box-shadow: 0 4px 12px rgba(17,60,207,0.3); transition: all 0.2s;" target="_blank">View Ticket Status 🎫</a>
                                        <!--<![endif]-->
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin: 0 0 20px 0;">
                                <p style="font-size: 13px; font-weight: 600; color: #1a1a1a; margin: 0 0 8px 0;">💡 Need immediate help?</p>
    ...
    text = f"""🎫 Support Ticket Created - CineBrain
...
• You'll receive email updates when we respond
• Reply to this email to add more information
• Use ticket number #{ticket_number} in all communications
...
Ticket #{ticket_number} • Created on {datetime.now().strftime('%B %d, %Y')}
...
<body style="margin: 0; padding: 0; background-color: #f6f9fc; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="container" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td class="header-cell" align="center" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 40px 24px;">
                            <img src="{BRAND_IMAGE_URL}" alt="CineBrain" class="brand-img" width="220" height="auto" style="display: block; margin: 0 auto 16px auto; max-width: 100%;">
                            <p style="color: #ffffff; font-size: 16px; margin: 0; opacity: 0.9; font-weight: 500;">💌 Message Received</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 36px 40px 24px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-radius: 12px; border: 1px solid #a7f3d0; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 24px;">
                                        <h3 style="font-size: 16px; font-weight: 700; color: #065f46; margin: 0 0 16px 0;">📨 Your Message</h3>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="btn-container">
                                <tr>
                                    <td align="center" style="padding: 8px 0 24px 0;">
                                        ...
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{FRONTEND_URL}/support" class="btn" style="display: inline-block; background: #113CCF; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 700; padding: 15px 32px; border-radius: 8px; box-shadow: 0 4px 12px rgba(17,60,207,0.3); transition: all 0.2s;" target="_blank">Visit Support Center 🏠</a>
                                        <!--<![endif]-->
                                    </td>
                                </tr>
                            </table>
    ...
    text = f"""✅ Message Received - CineBrain
...
<body style="margin: 0; padding: 0; background-color: #f6f9fc; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="container" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td class="header-cell" align="center" style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); padding: 40px 24px;">
                            <img src="{BRAND_IMAGE_URL}" alt="CineBrain" class="brand-img" width="220" height="auto" style="display: block; margin: 0 auto 16px auto; max-width: 100%;">
                            <p style="color: #ffffff; font-size: 16px; margin: 0; opacity: 0.9; font-weight: 500;">🐛 Issue Tracker</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 36px 40px 24px;">
                            <!-- Success Header -->
                            <div align="center" style="margin: 0 0 32px 0;">
                                <div style="font-size: 48px; line-height: 1; margin: 0 0 16px 0;">🛠️</div>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: linear-gradient(135deg, #fef2f2 0%, #fee2e2 100%); border-radius: 12px; border: 1px solid #fca5a5; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 24px;">
                                        <h3 style="font-size: 16px; font-weight: 700; color: #991b1b; margin: 0 0 16px 0;">🐞 Issue Details</h3>
                            ...
                            <!-- What's Next -->
                            <div style="background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border: 1px solid #93c5fd; border-radius: 10px; padding: 20px; margin: 0 0 24px 0;">
                                <h3 style="font-size: 15px; font-weight: 700; color: #1e40af; margin: 0 0 12px 0;">⚙️ What happens next?</h3>
                                <ul style="font-size: 13px; color: #1e3a8a; margin: 0; padding-left: 18px; line-height: 1.5;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="btn-container">
                                <tr>
                                    <td align="center" style="padding: 8px 0 24px 0;">
                                        ...
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{FRONTEND_URL}/support/report-issue" class="btn btn-inline" style="display: inline-block; background: #10b981; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 700; padding: 14px 28px; border-radius: 8px; box-shadow: 0 4px 12px rgba(16,185,129,0.3); transition: all 0.2s;" target="_blank">Report Another 🐛</a>
                                        <!--<![endif]-->
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="footer-cell" style="background-color: #f9fafb; padding: 24px 40px; border-top: 1px solid #e5e7eb;">
                            <p class="copyright" align="center" style="font-size: 12px; color: #9ca3af; margin: 0 0 12px 0; line-height: 1.5;">© {datetime.now().year} CineBrain Development Team. All rights reserved.<br>Issue #{ticket_number} • Reported on {datetime.now().strftime('%B %d, %Y')}</p>
                            
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td align="center" style="padding: 0;">
                                        <a href="{FRONTEND_URL}/support" class="footer-link" style="color: #6b7280; text-decoration: none; font-size: 13px; margin: 0 10px; font-weight: 500;">Support Center</a><span class="footer-divider" style="color: #d1d5db; margin: 0 3px;">•</span><a href="{FRONTEND_URL}/changelog" class="footer-link" style="color: #6b7280; text-decoration: none; font-size: 13px; margin: 0 10px; font-weight: 500;">Changelog</a><span class="footer-divider" style="color: #d1d5db; margin: 0 3px;">•</span><a href="{FRONTEND_URL}/support/report-issue" class="footer-link" style="color: #6b7280; text-decoration: none; font-size: 13px; margin: 0 10px; font-weight: 500;">Report Issue</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    text = f"""🛠️ Issue Report Received - CineBrain
...
Issue Details:
• Report ID: #{ticket_number}
• Title: {issue_title}
• Type: {issue_type}
• Severity: {severity.upper()}

What happens next:
• Our development team will reproduce and investigate the issue
• Critical bugs are prioritized for immediate fixes
• You'll be notified when the issue is resolved
• Track progress in our changelog and updates
...
Issue #{ticket_number} • Reported on {datetime.now().strftime('%B %d, %Y')}
...
<body style="margin: 0; padding: 0; background-color: #f6f9fc; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="container" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td class="header-cell" align="center" style="background: linear-gradient(135deg, #7c3aed 0%, #5b21b6 100%); padding: 40px 24px;">
                            <img src="{BRAND_IMAGE_URL}" alt="CineBrain" class="brand-img" width="220" height="auto" style="display: block; margin: 0 auto 16px auto; max-width: 100%;">
                            <p style="color: #ffffff; font-size: 16px; margin: 0; opacity: 0.9; font-weight: 500;">💬 New Response</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 36px 40px 24px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-radius: 12px; border: 1px solid #e5e7eb; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 24px;">
                                        <h3 style="font-size: 16px; font-weight: 700; color: #1a1a1a; margin: 0 0 16px 0;">💬 Response from {staff_name}</h3>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="btn-container">
                                <tr>
                                    <td align="center" style="padding: 8px 0 24px 0;">
                                        ...
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{FRONTEND_URL}/support/ticket/{ticket_number}" class="btn" style="display: inline-block; background: #113CCF; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 700; padding: 15px 32px; border-radius: 8px; box-shadow: 0 4px 12px rgba(17,60,207,0.3); transition: all 0.2s;" target="_blank">View Full Conversation 💬</a>
                                        <!--<![endif]-->
                                    </td>
                                </tr>
                            </table>
                            ...
                            <!-- Reply Info -->
                            <div style="background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); border: 1px solid #93c5fd; border-radius: 10px; padding: 20px; margin: 0 0 24px 0;">
                                <h3 style="font-size: 15px; font-weight: 700; color: #1e40af; margin: 0 0 12px 0;">📧 Need to reply?</h3>
                    ...
                    <tr>
                        <td class="footer-cell" style="background-color: #f9fafb; padding: 24px 40px; border-top: 1px solid #e5e7eb;">
                            <p class="copyright" align="center" style="font-size: 12px; color: #9ca3af; margin: 0 0 12px 0; line-height: 1.5;">© {datetime.now().year} CineBrain Support Team. All rights reserved.<br>Ticket #{ticket_number} • {datetime.now().strftime('%B %d, %Y')}</p>
    ...
    text = f"""💬 New Response - Ticket #{ticket_number}
...
<body style="margin: 0; padding: 0; background-color: #f6f9fc; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="container" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td class="header-cell" align="center" style="background: linear-gradient(135deg, #ec4899 0%, #db2777 100%); padding: 40px 24px;">
                            <img src="{BRAND_IMAGE_URL}" alt="CineBrain" class="brand-img" width="220" height="auto" style="display: block; margin: 0 auto 16px auto; max-width: 100%;">
                            <p style="color: #ffffff; font-size: 16px; margin: 0; opacity: 0.9; font-weight: 500;">💝 Thank You!</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 36px 40px 24px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: linear-gradient(135deg, #fdf2f8 0%, #fce7f3 100%); border-radius: 12px; border: 1px solid #f9a8d4; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 24px;">
                                        <h3 style="font-size: 16px; font-weight: 700; color: #be185d; margin: 0 0 16px 0;">💌 Your Feedback</h3>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="btn-container">
                                <tr>
                                    <td align="center" style="padding: 8px 0 24px 0;">
                                        ...
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{FRONTEND_URL}/changelog" class="btn" style="display: inline-block; background: #113CCF; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 700; padding: 15px 32px; border-radius: 8px; box-shadow: 0 4px 12px rgba(17,60,207,0.3); transition: all 0.2s;" target="_blank">View Changelog 📋</a>
                                        <!--<![endif]-->
                                    </td>
                                </tr>
                            </table>
    ...
    text = f"""🌟 Feedback Received - CineBrain
...
What happens next:
• Our product team reviews all feedback carefully
• Your suggestions directly influence our roadmap
• Watch our changelog to see when features are implemented
...
<body style="margin: 0; padding: 0; background-color: #f6f9fc; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="container" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td class="header-cell" align="center" style="background: linear-gradient(135deg, {status_color} 0%, {status_color}dd 100%); padding: 40px 24px;">
                            <img src="{BRAND_IMAGE_URL}" alt="CineBrain" class="brand-img" width="220" height="auto" style="display: block; margin: 0 auto 16px auto; max-width: 100%;">
                            <p style="color: #ffffff; font-size: 16px; margin: 0; opacity: 0.9; font-weight: 500;">🔄 Status Update</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-cell" style="padding: 36px 40px 24px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-radius: 12px; border: 1px solid #e5e7eb; margin: 0 0 24px 0;">
                                <tr>
                                    <td style="padding: 24px;">
                                        <h3 style="font-size: 16px; font-weight: 700; color: #1a1a1a; margin: 0 0 16px 0;">🔄 Status Change</h3>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="btn-container">
                                <tr>
                                    <td align="center" style="padding: 8px 0 24px 0;">
                                        ...
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{FRONTEND_URL}/support/ticket/{ticket_number}" class="btn" style="display: inline-block; background: #113CCF; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 700; padding: 15px 32px; border-radius: 8px; box-shadow: 0 4px 12px rgba(17,60,207,0.3); transition: all 0.2s;" target="_blank">View Ticket Details 📋</a>
                                        <!--<![endif]-->
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class="footer-cell" style="background-color: #f9fafb; padding: 24px 40px; border-top: 1px solid #e5e7eb;">
                            <p class="copyright" align="center" style="font-size: 12px; color: #9ca3af; margin: 0 0 12px 0; line-height: 1.5;">© {datetime.now().year} CineBrain Support Team. All rights reserved.<br>Ticket #{ticket_number} • Updated by {staff_name}</p>
    ...
    text = f"""🔄 Ticket Status Updated - #{ticket_number}
...
---
© {datetime.now().year} CineBrain Support Team
Ticket #{ticket_number} • Updated by {staff_name}
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="container" style="width: 100%; max-width: 600px; background-color: #ffffff; border-radius: 12px;">
                    <tr>
                        <td class="header-cell" align="center" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); padding: 32px 24px;">
                            ...
                            <p style="color: #ffffff; font-size: 16px; margin: 0; opacity: 0.9; font-weight: 500;">🔔 Admin Alert</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="content-cell" style="padding: 36px 40px 24px;">
